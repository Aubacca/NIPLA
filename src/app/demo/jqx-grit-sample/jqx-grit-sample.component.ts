...
@Component({
  selector: 'app-jqx-grit-sample',
  templateUrl: './jqx-grit-sample.component.html',
  styleUrls: ['./jqx-grit-sample.component.css']
})
export class JqxGritSampleComponent implements OnInit {
  source: any = {
    localdata: [
